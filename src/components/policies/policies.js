    ...
    return(
      <div className='policiesContainer'>
        ...
        <div className='policyContent'>
          <p>In an effort to keep payments timely, encourage lesson regularity, and avoid complicated reschedules all students are required to agree to and sign the Payment Policy, Cancellation Policy, and Lesson Credit System.
